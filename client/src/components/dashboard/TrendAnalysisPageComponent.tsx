...
export interface TrendAnalysisPageProps {
  sessionID: string | number;
  showBackButton?: boolean;
  headerTitle?: string;
}

export interface TrendAnalysisPageHandle {
...
const TrendAnalysisPageComponent = forwardRef<TrendAnalysisPageHandle, TrendAnalysisPageProps>(({
  sessionID,
