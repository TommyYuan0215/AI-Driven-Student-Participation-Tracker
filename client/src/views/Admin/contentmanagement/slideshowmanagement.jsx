  ...
  return (
    <>
              ...
              <Table striped bordered hover responsive className="align-middle">
                <thead className="table-light">
                  <tr className="text-center">
                    ...
                    <th onClick={() => handleSort("slideshowID")}
                    ...
                    <th onClick={() => handleSort("slideshowTitle")}
                      style={{ width: "180px", cursor: "pointer" }}>Title{" "}
      ...
      <Pagination className="d-flex justify-content-end">
        ...
        {currentPage <
          Math.ceil(slideshowData.length / itemsPerPage) - 2 && (
