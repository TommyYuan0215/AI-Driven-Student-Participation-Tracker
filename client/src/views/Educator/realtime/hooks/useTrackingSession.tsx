...
export function useTrackingSession(
  ...
  mediaStreamRef: React.MutableRefObject<any>,
  stopScreenShare: (callback?: () => void) => void
) {
  ...
  const [notificationInterval] = useState(60);
  const lastNotificationTimeRef = useRef(0);
  const notificationHistoryRef = useRef<NotificationItem[]>([]);
